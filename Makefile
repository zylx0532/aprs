all: aprsudp aprstcp aprscmdtcp udptoaprs udptomysql udptolog udptolocal aprstomysql aprs.fi.toudp local.toudp local.toaprs gt02 udptomysql2 resendaprs testutil

testutil: testutil.c util.c
	gcc -g -o testutil testutil.c -Wall -lm

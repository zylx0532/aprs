...
int main (int argc, char **argv) {
	...
	testutil("BI8CYW-6>AP51WX:,3134.10123N/12020.10456E_000/003g006t064r000p000h71b10090,086,119,138,057,078,091,000051WS5 23.8V");
	testutil("BI8CYW-6>APRS,TCPIP*:!/>Ez#l,q=> PulseModem A");
	exit(0);
}
